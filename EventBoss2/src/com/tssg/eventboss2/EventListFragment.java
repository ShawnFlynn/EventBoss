...
////		setListAdapter(new ArrayAdapter<EB2MainActivity>(getActivity(),
////				android.R.layout.simple_list_item_activated_1,
////				android.R.id.text1, EventListDisplayActivity.m_webEventsList.getBELEventList();
...
////		mCallbacks.onItemSelected(EventContent.EVENT_ITEMS.get(position).mId);
		...
		mCallbacks.onItemSelected((EventListDisplayActivity.m_webEventsList.get(position).getId()).toString());
		////// really???
	}
