...
public class EventListActivity extends FragmentActivity 
	...
	/**
	 * mTwoPane indicates whether or not the activity is in two-pane mode, 
	 ...
	 * @param id identifier of which event the user tapped on
	 */
	@Override
	public void onItemSelected(String id) {
		...
		Log.v("start EventDetailActivity","for id: "+ id );
